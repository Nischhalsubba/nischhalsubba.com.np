 ...
 * Purpose: Initialize the sitewide interaction-motion feature after DOM readiness without adding motion-domain logic to the main application entrypoint.
 * Responsibilities:
 * - Wait until authored controls exist before initializing the shared button-motion system.
...
import { initButtonMotion } from '../features/motion/button-motion.js';

onReady(initButtonMotion);
