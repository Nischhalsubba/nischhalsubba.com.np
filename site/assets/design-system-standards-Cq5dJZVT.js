const a="nrs-design-system-standards";function t(){let r=document.getElementById(a);r||(r=document.createElement("style"),r.id=a,document.head.appendChild(r)),r.textContent=`
    :root {
      --radius-card: 18px;
      --radius-control: 18px;
      --card-bg: transparent;
  ...
  `}function o(){t(),requestAnimationFrame(t),window.setTimeout(t,250),window.setTimeout(t,1e3)}export{o as applyDesignSystemStandards};
