const r="nrs-about-contact-standards";function n(){let t=document.getElementById(r);t||(t=document.createElement("style"),t.id=r,document.head.appendChild(t)),t.textContent=`
    .nrs-about-redesign,
  ...
  `}function a(){n(),requestAnimationFrame(n),window.setTimeout(n,250),window.setTimeout(n,1e3)}export{a as applyAboutContactStandards};
