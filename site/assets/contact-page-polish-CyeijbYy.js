function o(){let t=document.getElementById("nrs-contact-page-polish");t||(t=document.createElement("style"),t.id="nrs-contact-page-polish",document.head.appendChild(t)),t.textContent=`
    .contact-layout {
  ...
  `}function a(){o(),requestAnimationFrame(o),window.setTimeout(o,250),window.setTimeout(o,700)}export{a as polishContactPage};
