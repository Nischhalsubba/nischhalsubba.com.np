function i(){let t=document.getElementById("nrs-list-spacing-polish");t||(t=document.createElement("style"),t.id="nrs-list-spacing-polish",document.head.appendChild(t)),t.textContent=`
    :root {
  ...
  `}function o(){i(),requestAnimationFrame(i),window.setTimeout(i,250)}export{o as polishListSpacing};
