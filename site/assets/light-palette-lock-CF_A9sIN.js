const e="nrs-light-palette-lock";function a(){let t=document.getElementById(e);t||(t=document.createElement("style"),t.id=e,document.head.appendChild(t)),t.textContent=`
  ...
  `}function h(){a(),requestAnimationFrame(a),window.setTimeout(a,0),window.setTimeout(a,250),window.setTimeout(a,700)}export{h as lockLightThemePalette};
