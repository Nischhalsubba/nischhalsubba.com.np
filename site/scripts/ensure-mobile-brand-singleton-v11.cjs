...
const brandMarkup = '<a id="mobile-site-brand" class="agent-mobile-brand" href="/" data-motion="off" aria-label="Nischhal Raj Subba, home"><span class="mobile-site-brand__text">Nischhal Raj Subba</span></a>';
