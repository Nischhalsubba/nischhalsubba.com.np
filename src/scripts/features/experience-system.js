...
function addWayfinding() {
  ...
  const anchor = main.querySelector(
    ".hero-section, .nrs-services-hero, .nrs-contact-v3-hero, article, section",
  );
...
function improveMediaLoading() {
  const heroMedia = new Set(
    document.querySelectorAll(
      ".hero-section img, .nrs-services-hero img, .nrs-contact-v3-hero img, .case-hero-img-container img",
    ),
  );
...
function markInteractiveElements() {
  ...
  document
    ...
    .forEach((element) => element.classList.add("nrs-cursor-target"));
  document
    .querySelectorAll("main img, main video, main iframe")
    .forEach((element) => element.setAttribute("data-cursor-mode", "media"));
  document
    .querySelectorAll("main p, main li, main h1, main h2, main h3, main h4")
    .forEach((element) => element.setAttribute("data-cursor-mode", "text"));
  document
