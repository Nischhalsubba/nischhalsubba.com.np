...
**Branch-aware technical guide for [`update_worker_name_to_portfolio-website-2026`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/update_worker_name_to_portfolio-website-2026)**

<p><img alt="branch: update_worker_name_to_portfolio-website-2026" src="https://img.shields.io/static/v1?label=&message=branch%3A%20update_worker_name_to_portfolio-website-2026&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/update_worker_name_to_portfolio-website-2026"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=update_worker_name_to_portfolio-website-2026"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `update_worker_name_to_portfolio-website-2026`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
| Stack | Vite, TypeScript, WordPress, HTML, PHP, JavaScript, CSS |
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/update_worker_name_to_portfolio-website-2026/README.md)
- [`wrangler.jsonc`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/update_worker_name_to_portfolio-website-2026/wrangler.jsonc)
...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / update_worker_name_to_portfolio-website-2026"]
    ROOT --> P0["assets/"]
    ROOT --> P1["blog/"]
    ROOT --> P2["docs/"]
    ROOT --> P3["public/"]
    ...
    ROOT --> MORE["+ 66 more top-level entries"]
```

| Responsibility | Detected source paths |
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/update_worker_name_to_portfolio-website-2026/public) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/update_worker_name_to_portfolio-website-2026/docs) |
| Delivery | [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/update_worker_name_to_portfolio-website-2026/scripts) |
...
```mermaid
flowchart LR
    CHANGE["Change on update_worker_name_to_portfolio-website-2026"] --> CHECK["Tests and quality checks"]
...
| Branch | [`update_worker_name_to_portfolio-website-2026`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/update_worker_name_to_portfolio-website-2026) |
