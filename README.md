...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`update_worker_name_to_portfolio-website-2026`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/update_worker_name_to_portfolio-website-2026). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on update_worker_name_to_portfolio-website-2026"]
