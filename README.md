...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`backup/main-after-initial-audit-fixes-2026-07-10`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/backup/main-after-initial-audit-fixes-2026-07-10). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on backup/main-after-initial-audit-fixes-2026-07-10"]
