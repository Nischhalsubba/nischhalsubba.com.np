...
**Branch-aware technical guide for [`agent/refresh-ux-audit-prioritization`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization)**

<p><img alt="branch: agent/refresh-ux-audit-prioritization" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Frefresh-ux-audit-prioritization&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=agent%2Frefresh-ux-audit-prioritization"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/refresh-ux-audit-prioritization`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/README.md)
- [`blog/index.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/blog/index.html)
- [`blog/prioritize-ux-audit-findings-before-redesign.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/blog/prioritize-ux-audit-findings-before-redesign.html)
- [`llms.txt`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/llms.txt)
- [`public/sitemap.xml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/public/sitemap.xml)
- [`sitemap.xml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/sitemap.xml)
...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / agent/refresh-ux-audit-prioritization"]
    ROOT --> P0[".github/"]
    ROOT --> P1["api/"]
    ROOT --> P2["assets/"]
    ROOT --> P3["blog/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/src) |
| Application logic | [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/api) |
| Data | [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/data) |
| Quality | [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/.github), [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/scripts) |
...
Detected API or server areas: [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/api).
...
Detected data areas: [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/data).
...
Relevant detected files: [`src/worker.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/src/worker.js).
...
- [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization/tests)
...
- [`src/scripts/features/analytics-events.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/src/scripts/features/analytics-events.js)
- [`assets/analytics-events-Bq4IAYSg.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/assets/analytics-events-Bq4IAYSg.js)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/refresh-ux-audit-prioritization"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/browser-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/.github/workflows/browser-audit.yml)
- [`.github/workflows/deploy-cloudflare.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/.github/workflows/deploy-cloudflare.yml)
- [`.github/workflows/production-qa.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/.github/workflows/production-qa.yml)
- [`.github/workflows/production-route-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/.github/workflows/production-route-audit.yml)
- [`.github/workflows/validate.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/refresh-ux-audit-prioritization/.github/workflows/validate.yml)
...
| Branch | [`agent/refresh-ux-audit-prioritization`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization) |
