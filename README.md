...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/refresh-ux-audit-prioritization`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/refresh-ux-audit-prioritization). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/refresh-ux-audit-prioritization"]
