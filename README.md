...
**Branch-aware technical guide for [`fix/cloudflare-worker-contact`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact)**

<p><img alt="branch: fix/cloudflare-worker-contact" src="https://img.shields.io/static/v1?label=&message=branch%3A%20fix%2Fcloudflare-worker-contact&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=fix%2Fcloudflare-worker-contact"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `fix/cloudflare-worker-contact`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/README.md)
- [`src/worker.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/src/worker.js)
- [`wrangler.jsonc`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/wrangler.jsonc)
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/src) |
| Application logic | [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/api) |
| Data | [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/data) |
| Quality | [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/.github), [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/scripts) |
...
Detected API or server areas: [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/api).
...
Detected data areas: [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/data).
...
Relevant detected files: [`src/worker.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/src/worker.js).
...
- [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/cloudflare-worker-contact/tests)
...
- [`src/scripts/features/analytics-events.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/src/scripts/features/analytics-events.js)
- [`assets/analytics-events-Bq4IAYSg.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/assets/analytics-events-Bq4IAYSg.js)
...
```mermaid
flowchart LR
    CHANGE["Change on fix/cloudflare-worker-contact"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/browser-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/.github/workflows/browser-audit.yml)
- [`.github/workflows/deploy-cloudflare.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/.github/workflows/deploy-cloudflare.yml)
- [`.github/workflows/production-route-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/.github/workflows/production-route-audit.yml)
- [`.github/workflows/validate.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/cloudflare-worker-contact/.github/workflows/validate.yml)
