...
**Branch-aware technical guide for [`codebase-cleanup-2026`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/codebase-cleanup-2026)**

<p><img alt="branch: codebase-cleanup-2026" src="https://img.shields.io/static/v1?label=&message=branch%3A%20codebase-cleanup-2026&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/codebase-cleanup-2026"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=codebase-cleanup-2026"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `codebase-cleanup-2026`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`404.php`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/404.php)
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/README.md)
- [`README.txt`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/README.txt)
- [`_redirects`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/_redirects)
- [`archive-project.php`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/archive-project.php)
- [`blog-accessibility-fintech.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/blog-accessibility-fintech.html)
- [`blog-ai-ops.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/blog-ai-ops.html)
- [`blog-design-metrics.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/blog-design-metrics.html)
- [`blog-design-systems-front-end.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/blog-design-systems-front-end.html)
- [`blog-detail.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/blog-detail.html)
- [`blog-gaming-interface-clarity.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/blog-gaming-interface-clarity.html)
- [`blog-good-handoff.html`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/codebase-cleanup-2026/blog-good-handoff.html)
...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / codebase-cleanup-2026"]
    ROOT --> P0["assets/"]
    ROOT --> P1["blog/"]
    ROOT --> P2["docs/"]
    ROOT --> P3["public/"]
    ...
    ROOT --> P5["src/"]
    ROOT --> P6["wordpress/"]
    ROOT --> P7[".editorconfig"]
    ROOT --> P8[".gitignore"]
    ROOT --> P9["about.html"]
    ROOT --> P10["ai-profile.json"]
    ROOT --> P11["blog-enterprise-ux.html"]
    ROOT --> P12["blog-governance.html"]
    ROOT --> P13["blog-handoff.html"]
    ROOT --> P14["blog-pricing-ux.html"]
    ROOT --> P15["blog-research-emerging.html"]
    ROOT --> P16["blog-web3-ux.html"]
    ROOT --> P17["blog.html"]
    ROOT --> MORE["+ 54 more top-level entries"]
```

| Responsibility | Detected source paths |
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/codebase-cleanup-2026/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/codebase-cleanup-2026/src) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/codebase-cleanup-2026/docs) |
| Delivery | [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/codebase-cleanup-2026/scripts) |
...
flowchart TD
    ...
    R0 --> F2["public/blog/transaction-review-ux-crypto-apps.html"]
    R0 --> F3["public/blog/saas-dashboard-ux-checklist.html"]
    R0 --> F4["public/blog/website-ux-checklist-software-companies.html"]
    R0 --> F5["public/blog/web3-wallet-ux-checklist.html"]
    R0 --> F6["public/blog/ux-audit-checklist-before-redesign.html"]
    R0 --> F7["public/blog/figma-handoff-notes-for-developers.html"]
```
...
```mermaid
flowchart LR
    CHANGE["Change on codebase-cleanup-2026"] --> CHECK["Tests and quality checks"]
...
| Branch | [`codebase-cleanup-2026`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/codebase-cleanup-2026) |
