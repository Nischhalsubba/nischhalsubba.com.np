...
**Branch-aware technical guide for [`email-signature-headshot-20260629`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/email-signature-headshot-20260629)**

<p><img alt="branch: email-signature-headshot-20260629" src="https://img.shields.io/static/v1?label=&message=branch%3A%20email-signature-headshot-20260629&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/email-signature-headshot-20260629"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=email-signature-headshot-20260629"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `email-signature-headshot-20260629`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/email-signature-headshot-20260629/README.md)
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/email-signature-headshot-20260629/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/email-signature-headshot-20260629/src) |
| Quality | [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/email-signature-headshot-20260629/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/email-signature-headshot-20260629/docs) |
| Delivery | [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/email-signature-headshot-20260629/scripts) |
...
flowchart TD
    ...
    R1 --> F6["public/blog/transaction-review-ux-crypto-apps.html"]
    R1 --> F7["public/blog/saas-dashboard-ux-checklist.html"]
    R1 --> F8["public/blog/prioritize-ux-audit-findings-before-redesign.html"]
    R1 --> F9["public/blog/website-ux-checklist-software-companies.html"]
    R1 --> F10["public/blog/saas-dashboard-empty-state-ux-guide.html"]
    R1 --> F11["public/blog/web3-wallet-ux-checklist.html"]
```
...
- [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/email-signature-headshot-20260629/tests)
...
- [`src/scripts/features/analytics-events.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/email-signature-headshot-20260629/src/scripts/features/analytics-events.js)
...
```mermaid
flowchart LR
    CHANGE["Change on email-signature-headshot-20260629"] --> CHECK["Tests and quality checks"]
