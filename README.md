...
**Branch-aware technical guide for [`feat/complete-portfolio-qa`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa)**

<p><img alt="branch: feat/complete-portfolio-qa" src="https://img.shields.io/static/v1?label=&message=branch%3A%20feat%2Fcomplete-portfolio-qa&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=feat%2Fcomplete-portfolio-qa"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `feat/complete-portfolio-qa`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/README.md)
- [`functions/api/contact-policy.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/functions/api/contact-policy.js)
- [`functions/api/contact.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/functions/api/contact.js)
- [`package.json`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/package.json)
- [`scripts/build-dist.cjs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/scripts/build-dist.cjs)
- [`scripts/spacious-pages/home-work.cjs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/scripts/spacious-pages/home-work.cjs)
- [`scripts/test-contact-policy.mjs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/scripts/test-contact-policy.mjs)
- [`src/scripts/features/contact-form.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/src/scripts/features/contact-form.js)
...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / feat/complete-portfolio-qa"]
    ROOT --> P0[".github/"]
    ROOT --> P1["api/"]
    ROOT --> P2["assets/"]
    ROOT --> P3["blog/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/src) |
| Application logic | [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/api) |
| Data | [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/data) |
| Quality | [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/.github), [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/scripts) |
...
Detected API or server areas: [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/api).
...
Detected data areas: [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/data).
...
Relevant detected files: [`src/worker.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/src/worker.js).
...
- [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa/tests)
...
- [`src/scripts/features/analytics-events.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/src/scripts/features/analytics-events.js)
- [`assets/analytics-events-Bq4IAYSg.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/assets/analytics-events-Bq4IAYSg.js)
...
```mermaid
flowchart LR
    CHANGE["Change on feat/complete-portfolio-qa"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/browser-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/.github/workflows/browser-audit.yml)
- [`.github/workflows/deploy-cloudflare.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/.github/workflows/deploy-cloudflare.yml)
- [`.github/workflows/production-qa.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/.github/workflows/production-qa.yml)
- [`.github/workflows/production-route-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/.github/workflows/production-route-audit.yml)
- [`.github/workflows/validate.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/feat/complete-portfolio-qa/.github/workflows/validate.yml)
...
| Branch | [`feat/complete-portfolio-qa`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/feat/complete-portfolio-qa) |
