...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / redesign/ui-ux-pro-max-2026"]
    ROOT --> P0["assets/"]
    ROOT --> P1["blog/"]
    ROOT --> P2["docs/"]
    ROOT --> P3["public/"]
    ...
    ROOT --> P10["_redirects"]
    ROOT --> P11["about.html"]
    ROOT --> P12["archive-project.php"]
    ROOT --> P13["blog-accessibility-fintech.html"]
    ROOT --> P14["blog-ai-ops.html"]
    ROOT --> P15["blog-design-metrics.html"]
    ROOT --> P16["blog-design-systems-front-end.html"]
    ROOT --> P17["blog-detail.html"]
    ROOT --> MORE["+ 68 more top-level entries"]
```
...
```mermaid
flowchart LR
    CHANGE["Change on redesign/ui-ux-pro-max-2026"] --> CHECK["Tests and quality checks"]
