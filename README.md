...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/spacious-core-pages`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/spacious-core-pages"]
