...
**Branch-aware technical guide for [`agent/spacious-core-pages`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages)**

<p><img alt="branch: agent/spacious-core-pages" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Fspacious-core-pages&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=agent%2Fspacious-core-pages"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/spacious-core-pages`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/spacious-core-pages/README.md)
...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / agent/spacious-core-pages"]
    ROOT --> P0[".github/"]
    ROOT --> P1["assets/"]
    ROOT --> P2["blog/"]
    ROOT --> P3["data/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/src) |
| Data | [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/data) |
| Quality | [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/.github), [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/scripts) |
...
Detected data areas: [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/data).
...
- [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages/tests)
...
- [`assets/analytics-events-Bq4IAYSg.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/spacious-core-pages/assets/analytics-events-Bq4IAYSg.js)
- [`src/scripts/features/analytics-events.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/spacious-core-pages/src/scripts/features/analytics-events.js)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/spacious-core-pages"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/validate.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/agent/spacious-core-pages/.github/workflows/validate.yml)
...
| Branch | [`agent/spacious-core-pages`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/agent/spacious-core-pages) |
