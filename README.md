...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`fix/remaining-portfolio-qa`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/remaining-portfolio-qa). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on fix/remaining-portfolio-qa"]
