...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`fix/vercel-contact-protection`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/vercel-contact-protection). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on fix/vercel-contact-protection"]
