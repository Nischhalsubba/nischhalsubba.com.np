...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`codebase-cleanup-2026`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/codebase-cleanup-2026). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on codebase-cleanup-2026"]
