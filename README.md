...
**Branch-aware technical guide for [`fix/contact-form-stuck-sending`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending)**

<p><img alt="branch: fix/contact-form-stuck-sending" src="https://img.shields.io/static/v1?label=&message=branch%3A%20fix%2Fcontact-form-stuck-sending&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=fix%2Fcontact-form-stuck-sending"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `fix/contact-form-stuck-sending`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/README.md)
- [`scripts/build-site.cjs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/scripts/build-site.cjs)
- [`src/scripts/features/contact-form.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/src/scripts/features/contact-form.js)
...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / fix/contact-form-stuck-sending"]
    ROOT --> P0[".github/"]
    ROOT --> P1["api/"]
    ROOT --> P2["assets/"]
    ROOT --> P3["blog/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/src) |
| Application logic | [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/api) |
| Data | [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/data) |
| Quality | [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/.github), [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/scripts) |
...
Detected API or server areas: [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/api).
...
Detected data areas: [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/data).
...
Relevant detected files: [`src/worker.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/src/worker.js).
...
- [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending/tests)
...
- [`src/scripts/features/analytics-events.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/src/scripts/features/analytics-events.js)
- [`assets/analytics-events-Bq4IAYSg.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/assets/analytics-events-Bq4IAYSg.js)
...
```mermaid
flowchart LR
    CHANGE["Change on fix/contact-form-stuck-sending"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/browser-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/.github/workflows/browser-audit.yml)
- [`.github/workflows/deploy-cloudflare.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/.github/workflows/deploy-cloudflare.yml)
- [`.github/workflows/production-route-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/.github/workflows/production-route-audit.yml)
- [`.github/workflows/validate.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/contact-form-stuck-sending/.github/workflows/validate.yml)
...
| Branch | [`fix/contact-form-stuck-sending`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/contact-form-stuck-sending) |
