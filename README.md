...
**Branch-aware technical guide for [`chore/sync-turnstile-secret-config`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config)**

<p><img alt="branch: chore/sync-turnstile-secret-config" src="https://img.shields.io/static/v1?label=&message=branch%3A%20chore%2Fsync-turnstile-secret-config&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=chore%2Fsync-turnstile-secret-config"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `chore/sync-turnstile-secret-config`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/chore/sync-turnstile-secret-config/README.md)
...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / chore/sync-turnstile-secret-config"]
    ROOT --> P0[".github/"]
    ROOT --> P1["api/"]
    ROOT --> P2["assets/"]
    ROOT --> P3["blog/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/src) |
| Application logic | [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/api) |
| Data | [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/data) |
| Quality | [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/.github), [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/scripts) |
...
Detected API or server areas: [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/api).
...
Detected data areas: [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/data).
...
Relevant detected files: [`src/worker.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/chore/sync-turnstile-secret-config/src/worker.js).
...
- [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config/tests)
...
- [`src/scripts/features/analytics-events.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/chore/sync-turnstile-secret-config/src/scripts/features/analytics-events.js)
- [`assets/analytics-events-Bq4IAYSg.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/chore/sync-turnstile-secret-config/assets/analytics-events-Bq4IAYSg.js)
...
```mermaid
flowchart LR
    CHANGE["Change on chore/sync-turnstile-secret-config"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/browser-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/chore/sync-turnstile-secret-config/.github/workflows/browser-audit.yml)
- [`.github/workflows/deploy-cloudflare.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/chore/sync-turnstile-secret-config/.github/workflows/deploy-cloudflare.yml)
- [`.github/workflows/production-route-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/chore/sync-turnstile-secret-config/.github/workflows/production-route-audit.yml)
- [`.github/workflows/validate.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/chore/sync-turnstile-secret-config/.github/workflows/validate.yml)
...
| Branch | [`chore/sync-turnstile-secret-config`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config) |
