...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`chore/sync-turnstile-secret-config`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/chore/sync-turnstile-secret-config). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on chore/sync-turnstile-secret-config"]
