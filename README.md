...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`fix/comprehensive-portfolio-audit`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/comprehensive-portfolio-audit). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on fix/comprehensive-portfolio-audit"]
