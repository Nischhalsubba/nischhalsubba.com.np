...
**Branch-aware technical guide for [`fix/hero-pixel-story-v22`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22)**

<p><img alt="branch: fix/hero-pixel-story-v22" src="https://img.shields.io/static/v1?label=&message=branch%3A%20fix%2Fhero-pixel-story-v22&color=5965F2&style=flat-square"> <img alt="Vite" src="https://img.shields.io/static/v1?label=&message=Vite&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="WordPress" src="https://img.shields.io/static/v1?label=&message=WordPress&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="PHP" src="https://img.shields.io/static/v1?label=&message=PHP&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/nischhalsubba.com.np/codespaces/new?ref=fix%2Fhero-pixel-story-v22"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `fix/hero-pixel-story-v22`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/README.md)
...
```mermaid
flowchart TD
    ROOT["nischhalsubba.com.np / fix/hero-pixel-story-v22"]
    ROOT --> P0[".github/"]
    ROOT --> P1["api/"]
    ROOT --> P2["assets/"]
    ROOT --> P3["blog/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/public), [`src`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/src) |
| Application logic | [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/api) |
| Data | [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/data) |
| Quality | [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/.github), [`scripts`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/scripts) |
...
Detected API or server areas: [`api`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/api).
...
Detected data areas: [`data`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/data).
...
Relevant detected files: [`src/worker.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/src/worker.js).
...
- [`tests`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22/tests)
...
- [`src/scripts/features/analytics-events.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/src/scripts/features/analytics-events.js)
- [`assets/analytics-events-Bq4IAYSg.js`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/assets/analytics-events-Bq4IAYSg.js)
...
```mermaid
flowchart LR
    CHANGE["Change on fix/hero-pixel-story-v22"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/apply-interactive-readme.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/.github/workflows/apply-interactive-readme.yml)
- [`.github/workflows/browser-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/.github/workflows/browser-audit.yml)
- [`.github/workflows/deploy-cloudflare.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/.github/workflows/deploy-cloudflare.yml)
- [`.github/workflows/interface-polish-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/.github/workflows/interface-polish-audit.yml)
- [`.github/workflows/production-qa.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/.github/workflows/production-qa.yml)
- [`.github/workflows/production-route-audit.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/.github/workflows/production-route-audit.yml)
- [`.github/workflows/validate.yml`](https://github.com/Nischhalsubba/nischhalsubba.com.np/blob/fix/hero-pixel-story-v22/.github/workflows/validate.yml)
...
| Branch | [`fix/hero-pixel-story-v22`](https://github.com/Nischhalsubba/nischhalsubba.com.np/tree/fix/hero-pixel-story-v22) |
