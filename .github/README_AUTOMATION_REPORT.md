...
Repository: `Nischhalsubba/nischhalsubba.com.np`

Generator: `aed303eed8a536f2dda075c8be583693325aac37`

| Branch | Result | Detail |
|---|---|---|
| `agent/accessibility-security-hardening` | unchanged | README already matched the standard |
| `agent/atomic-runtime-delivery` | unchanged | README already matched the standard |
...
| `fix/qa-remediations-2026-08-10` | unchanged | README already matched the standard |
