...
const startMarker='/* nrs-single-source-inner-pages-v49:compiled:start */';
const endMarker='/* nrs-single-source-inner-pages-v49:compiled:end */';
...
stylesheet=stylesheet
  ...
  .replace(/Version:\s*[0-9.]+/,'Version: 49.0')
