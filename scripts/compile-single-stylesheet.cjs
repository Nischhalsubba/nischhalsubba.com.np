...
const startMarker='/* nrs-single-source-inner-pages-v48:compiled:start */';
const endMarker='/* nrs-single-source-inner-pages-v48:compiled:end */';
...
stylesheet=stylesheet
  ...
  .replace(/Version:\s*[0-9.]+/,'Version: 48.0')
...
console.log(`Compiled the spacious design system into ${path.relative(root,stylesheetPath)||'style.css'}.`);
