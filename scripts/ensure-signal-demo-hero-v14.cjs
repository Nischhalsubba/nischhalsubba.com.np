/**
 * @fileoverview scripts/ensure-signal-demo-hero-v14.cjs
 * Purpose: Apply the ensure signal demo hero v14 production transformation or maintenance step while preserving canonical source/build contracts.
 * Responsibilities:
 ...
 * Connected files:
 * - scripts/verify-signal-demo-source-v14.cjs
 * - package.json
