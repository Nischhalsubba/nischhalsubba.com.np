 ...
 * Inputs: `d`: input consumed by this operation; `out`: input consumed by this operation
 ...
 * Inputs: `rel`: input consumed by this operation
 ...
 * Inputs: `h`: input consumed by this operation
 * Side effects: No obvious external side effect beyond calls to supplied/imported dependencies..
