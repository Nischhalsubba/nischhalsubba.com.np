...
const stages = [
  ...
  ['Compose editorial Yarsha case study', ['node', 'scripts/spacious-pages/yarsha-editorial.cjs', '--dist']],
  ['Replace blocked project embeds', ['node', 'scripts/remove-blocked-project-embeds.cjs', '--dist']],
