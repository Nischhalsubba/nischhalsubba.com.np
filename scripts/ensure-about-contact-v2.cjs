...
const aboutHtml = `${head({
  ...
  <body>
${nav('about')}
    <main class="container nrs-about-v2">
      <section class="nrs-about-v2-hero reveal-on-scroll">
        <div class="nrs-about-v2-copy">
          ...
          <div class="cta-group"><a class="btn btn-primary" href="/projects.html">View selected work</a><a class="btn btn-secondary" href="/contact.html">Discuss a project</a></div>
        </div>
      ...
      <section class="nrs-about-v2-section nrs-about-v2-split reveal-on-scroll">
        ...
        <div class="nrs-about-v2-tags" aria-label="Best-fit work types">
          <span>SaaS dashboards</span><span>Web3 transaction flows</span><span>Fintech trust states</span><span>Mobile product UX</span><span>Product websites</span><span>Figma design systems</span><span>UX audits</span><span>Developer handoff</span>
        </div>
      </section>
      ...
      <section class="nrs-about-v2-cta reveal-on-scroll">
        ...
        <div class="cta-group"><a class="btn btn-primary" href="/projects.html">See case studies</a><a class="btn btn-secondary" href="/assets/resume.pdf" download="Nischhal-Raj-Subba-Resume.pdf" data-resume-download>Download Resume</a></div>
      </section>
    </main>
${scripts()}
  </body>
...
const contactHtml = `${head({
  ...
  <body>
${nav('contact')}
    <main class="container nrs-contact-v2">
      <section class="nrs-contact-v2-hero reveal-on-scroll">
        ...
        <form id="contact-form" class="nrs-contact-v2-form" action="https://formsubmit.co/${email}" method="POST">
          ...
          <label>Message<textarea name="message" rows="7" required placeholder="Tell me what you are building, who it is for, what is unclear, and where design should help."></textarea></label>
          ...
          <p id="contact-form-status" class="form-status" role="status" aria-live="polite">This form sends to ${email}. If the direct send is blocked, the email fallback opens with the same message.</p>
        </form>
      </section>
      ...
      <section class="nrs-contact-v2-footer-cta reveal-on-scroll">
        ...
        <div class="cta-group"><a class="btn btn-secondary" href="/projects.html">View work</a><a class="btn btn-secondary" href="/assets/resume.pdf" download="Nischhal-Raj-Subba-Resume.pdf" data-resume-download>Download Resume</a></div>
      </section>
    </main>
${scripts()}
  </body>
...
console.log('Generated About v2 and Contact v2 pages with working contact form.');
