    ...
    <a href="<?php echo get_template_directory_uri(); ?>/assets/resume.pdf" class="floating-resume-btn" download="Nischhal-Raj-Subba-Resume.pdf" type="application/pdf" aria-label="Download Resume">
