document.addEventListener('DOMContentLoaded', () => {
    ...
    // Dynamic Image Paths (fallback to relative if PHP not localized)
    const basePath = (typeof themeData !== 'undefined' && themeData.templateUrl) ? themeData.templateUrl + '/assets/images/' : 'assets/images/';
    
    // In WordPress, you might simply toggle CSS vars, but if swapping IMG src:
    const DARK_IMG = "https://i.imgur.com/ixsEpYM.png"; // Keeping hosted link for reliability
