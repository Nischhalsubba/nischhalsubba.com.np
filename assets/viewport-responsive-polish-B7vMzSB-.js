function n(){if(document.getElementById("nrs-viewport-responsive-polish"))return;const t=document.createElement("style");t.id="nrs-viewport-responsive-polish",t.textContent=`
    :root {
  ...
  `,document.head.appendChild(t)}function i(){n()}export{i as applyViewportResponsivePolish};
