const i="nrs-layout-system-uniformity";function t(){let r=document.getElementById(i);r||(r=document.createElement("style"),r.id=i,document.head.appendChild(r)),r.textContent=`
    :root {
  ...
  `}function e(){t(),requestAnimationFrame(t),window.setTimeout(t,250),window.setTimeout(t,1e3)}export{e as applyLayoutSystemUniformity};
